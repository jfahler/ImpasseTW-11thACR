//diag_log ["ITW_Garage",_this];
//if (is3DEN && {_fnc_scriptName == "bis_fnc_garage"}) exitwith {_this call ITW_Garage3DEN;};
...
*/
	...
	case "ListAdd": {
		...
		if (is3DEN) then {
			...
			["ShowItemInfo",[_cfg,gettext (_cfg >> "displayName")]] call ITW_Arsenal;
			["ShowItemStats",[_cfg]] call ITW_Garage;
		} else {
			{
				_items = _x;
				_ctrlList = _display displayctrl (IDC_RSCDISPLAYARSENAL_LIST + _foreachindex);
