//if !(_this#0 in ["Mouse","MouseButtonUp","MouseButtonDown","KeyDown","MouseZChanged","draw3D"]) then {diag_log ["ITW_Arsenal",_this]};
/*
	Author: 
...
switch _mode do
{
	...
	case "Init": 
	{
		...
		//INITTYPES 
		["InitGUI", [_display, "bis_fnc_arsenal"]] call ITW_Arsenal;
	...
	case "InitGUI": 
	{
		...
		if (is3DEN) then 
		{
			private _isArsenal = _function == "bis_fnc_arsenal";
